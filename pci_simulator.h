/**
 * pci_simulator.h  --  File operation definitions for PCI simulator Linux driver
 *                      Ubuntu 20.04 LTS
 *                      Linux kernel 5.15.0
 *
...
#ifndef PCI_SIMULATOR_H
#define PCI_SIMULATOR_H
...
#define WR_WAVEFORM  _IOR('a', 'h', IO_WAVEFORM *)
